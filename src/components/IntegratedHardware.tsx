...
const IntegratedHardware = () => {
  ...
  const handleNavigation = useCallback((direction: 'prev' | 'next') => {
    ...
    const maxScroll = (hardwares.length - numVisible) * itemWidth;
  ...
  useEffect(() => {
    ...
    const items = container.querySelectorAll('.hardware-card');
...
export default IntegratedHardware;
